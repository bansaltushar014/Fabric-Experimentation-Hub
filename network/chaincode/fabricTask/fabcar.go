...
func main() {
	...
	// tokenChaincode, err := contractapi.NewChaincode(&token.SmartContract{})
	// if err != nil {
	// 	fmt.Printf("Error creating token-erc-20 chaincode: %v", err)
	// }

	// if err := tokenChaincode.Start(); err != nil {
	// 	fmt.Printf("Error starting token-erc-20 chaincode: %v", err)
	// }
}
