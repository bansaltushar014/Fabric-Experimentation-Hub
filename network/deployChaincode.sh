...
setGlobalsForPeer0Org1() {
    ...
    # export CORE_PEER_MSPCONFIGPATH=${PWD}/artifacts/crypto-config/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/msp
...
approveForMyOrg2() {
    setGlobalsForPeer0Org2
     ...
     peer lifecycle chaincode approveformyorg -o localhost:7050 \
        ...
        --collections-config $PRIVATE_DATA_CONFIG \
        --version ${VERSION} --init-required --package-id fabcar_1:23df918915961296e5229590dafae0392209dd44e0072fc26b6222ab8ac08c32 \
        --sequence ${VERSION} 
